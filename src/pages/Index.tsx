...
const Landing = () => {
  ...
  const features = [
    ...
    { icon: Shield, titleEs: 'Formación Integral', titleEn: 'Comprehensive Training', descEs: 'Historia militar, leyes y orden cerrado', descEn: 'Military history, laws and close order drill' },
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[0.9] mb-6">
              {lang === 'es' ? 'Instrucción' : 'Pre-Military'}<br />
              <span className="text-military-green">{lang === 'es' ? 'Premilitar' : 'Instruction'}</span>
            </h1>
      ...
      <section>
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-md mx-auto">
            {lang === 'es'
              ? 'Regístrate y accede a todos los cursos de instrucción premilitar.'
