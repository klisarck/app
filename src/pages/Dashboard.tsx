...
const Dashboard = () => {
  ...
  const notifications = lang === 'es'
    ? [
        ...
        { text: 'Bienvenido a la plataforma UNEFA IPM', time: 'Hace 3d', dot: 'bg-muted-foreground' },
      ]
    : [
        ...
        { text: 'Welcome to the UNEFA PMI platform', time: '3d ago', dot: 'bg-muted-foreground' },
      ];
